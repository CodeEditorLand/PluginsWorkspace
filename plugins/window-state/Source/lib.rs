...
///
/// If using a custom filename, you should probably use
/// [`AppHandleExt::filename`] instead.
...
/// Used to prevent deadlocks from resize and position event listeners setting
/// the cached state on restoring states
...
impl Builder {
	...
	/// Sets a custom filename to use when saving and restoring window states
	/// from disk.
