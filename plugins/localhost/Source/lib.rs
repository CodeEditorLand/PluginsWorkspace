...
//! Expose your apps assets through a localhost server instead of the default
//! custom protocol.
//!
//! **Note: This plugins brings considerable security risks and you should only
//! use it if you know what your are doing. If in doubt, use the default custom
...
impl Builder {
	pub fn new(port:u16) -> Self { Self { port, host:None, on_request:None } }
