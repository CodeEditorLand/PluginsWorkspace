...
pub struct PermissionStatus {
	...
	///
	/// On Android 12+, users can choose between Approximate location
	/// (ACCESS_COARSE_LOCATION) and Precise location (ACCESS_FINE_LOCATION).
	///
...
pub struct PositionOptions {
	...
	/// Will be ignored on Android 12+ if users didn't grant the
	...
	/// acceptable to return. Default: 0
	/// Ignored on iOS.
