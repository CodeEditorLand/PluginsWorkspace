...
fn main() {
	...
	// TODO: triple check if this can reference the plugin's xml as it expects
	// rn TODO: This has to be configurable if we want to support handling nfc
	// tags when the app is not open.
