...
impl From<ConnectionConfig> for WebSocketConfig {
	fn from(config:ConnectionConfig) -> Self {
		// Disabling the warning on max_send_queue which we don't use anymore since it
		// was deprecated.
		#[allow(deprecated)]
		Self {
			max_send_queue:None,
			...
			// This may be harmful since if it's not provided from js we're overwriting the default
			// value with None, meaning no size limit.
