if ("__TAURI__" in window) {
	var __TAURI_PLUGIN_UPLOAD__ = (function (e) {
		"use strict";
		function t(e, t, n, o) {
			if ("a" === n && !o)
				throw new TypeError(
			...
			constructor() {
				(this.__TAURI_CHANNEL_MARKER__ = !0),
					...
					(this.id = (function (e, t = !1) {
						...
						if (i === t(this, s, "f")) {
							n(this, s, i + 1), t(this, o, "f").call(this, e);
							const a = Object.keys(t(this, r, "f"));
							if (a.length > 0) {
								let e = i + 1;
								for (const n of a.sort()) {
									if (parseInt(n) !== e) break;
									{
		...
		return (
			...
			(s = new WeakMap()),
			(r = new WeakMap()),
			(e.download = async function (e, t, n, o) {
			...
			(e.upload = async function (e, t, n, o) {
				const s = new Uint32Array(1);
				window.crypto.getRandomValues(s);
				const r = s[0],
					c = new i();
