...
// The TransferStats struct tracks both transfer speed and cumulative transfer
// progress.
pub struct TransferStats {
	...
	granularity:u32,             /* Time period (in milliseconds) over which the transfer speed
	                              * is calculated */
}
...
impl TransferStats {
	...
	// Records the transfer of a data chunk and updates both transfer speed and
	// total progress.
...
// Provides a default implementation for TransferStats with a granularity of 500
// milliseconds.
